        ...
        @if($buttonAddSubjects)
            <div class="flex flex-wrap -mx-3">
                <div class="w-full max-w-full px-3 mb-6 sm:w-4/4 sm:flex-none xl:mb-0 xl:w-4/4 text-right">
                    <x-button wire:click="$dispatch('ProgramDataSubjectsCreate_addSubjects')" class="btn btn-success btn-sm" label="Add subject" />
                    <x-button wire:click="$dispatch('ProgramDataSubjectsComponentImportExcel_enableAddsubjectsState')" class="btn btn-success btn-sm" label="Import Excel" />
                </div>
            </div>
        @endif
